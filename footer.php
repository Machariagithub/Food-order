			...
			<div class="col-3">
				<div class="pt-copy">
					...
					<div class="pt-lang">
						...
						<a hrfe="#" rel="en"><i class="flag-icon flag-icon-squared flag-icon-tz"></i></a>
						<a hrfe="#" rel="en"><i class="flag-icon flag-icon-squared flag-icon-ug"></i></a>
						<a hrfe="#" rel="en"><i class="flag-icon flag-icon-squared flag-icon-sa"></i></a>
					</div>
					Copyright &copy; 2023 <a href="<?=path?>">Quick Food</a>. All Rights Reserved.<br>
